...
import './Footer.css';
import './Root.css';
import logo from './TifoXR-no-text-blue.png';
import logo_rounded from './images/logo/TifoXR-TM-Logo-Round.png';
...
function Footer() {
    ...
    return (
        <>
            <footer className="pt-5 pb-1" id="footer">
                <div className="container-fluid px-4 px-lg-5">
                    <div className="top">
                        <div className="image">
                            <img src={logo_rounded} alt="TifoXR Logo" />
                        </div>
                    ...
                    <div className="bottom">
                        <p className="small text-center">
                            Copy &copy; All Rights Reserved<br />TifoXR - {year}
                        </p>
                    </div>
                </div>
            </footer>
