...
import './Footer.css';
import './Root.css';
import logo from './images/logo/TifoXR-TM-Logo-Round.png';
            ...
            <footer className="pt-5 pb-1" id="footer">
                <div className="container-fluid px-4 px-lg-5">
                    ...
                    <div className="bottom">
                        <p className="small text-center">Copy &copy; All Rights Reserved<br />TifoXR - {year}</p>
                    </div>
                </div>
            </footer>
        </>
